package net.juliomurillo.product.service;
...
@Service
@RequiredArgsConstructor //Se usa para inyectar productRepository por constructor y no usar @Autowired
public class ProductServiceImp implements ProductService{
	...
	public Product deleteProduct(Long id) {
		...
		productDB.setDelete_at(new Date());
		return productRepository.save(productDB);
	}
